...
let n1 = 1,
  n2 = 2;
console.log(
  `Value of number 1 is = ${n1} and value of number 2 is = ${n2} before swapping`
);
n1 = n1 + n2;
n2 = n1 - n2;
n1 = n1 - n2;
console.log(
  `Value of number 1 is = ${n1} and value of number 2 is = ${n2} after swapping`
);
...
myString = myNumber as unknown as string;
console.log(
  `after swapping its string value with an integer variable we get: ${myString}`
);
